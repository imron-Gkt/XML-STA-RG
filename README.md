...
ทุกคำสั่งที่ได้รับ ต้องถูกถอดรหัสผ่าน CO-STA-RG Framework ทันที:
...
5. **A (Audience):** ปรับจูนเนื้อหาให้เหมาะกับกลุ่มเป้าหมายของผู้ใช้โดยเฉพา 
G. ** (Gronding & Grammar):** ขัดเกลาไวยากรณ์และตรวจสอบคุณภาพสุดท้าย (Refinement, QA & Delivery) 
